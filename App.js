...
document.querySelector(".save").addEventListener("click", function () {
  ...
  const startTime = document.getElementById("task_start_time").value;
  const endTime = document.getElementById("task_end_time").value;
  const newTaskIcon = document.createElement("li");
  console.log(newTaskIcon)
//   newTaskIcon.className= "list-group-item";
//   newTaskIcon.innerHTML = `
...
//   `;
  ...
  //document.getElementById("middle_taskList").appendChild(newTaskIcon);
